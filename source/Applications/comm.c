...
void commInit(void) {
    ...
    //commData.portStreams[0] = COMM_STREAM_TYPE_TELEMETRY;
	...
	commData.portStreams[1] = COMM_STREAM_TYPE_TELEMETRY;
    ...
    flowControl = USART_HardwareFlowControl_RTS_CTS;
#endif
    commData.portHandles[2] = serialOpen(COMM_PORT3, 115200, flowControl, COMM_RX_BUF_SIZE, 0);
    commData.portStreams[2] = COMM_STREAM_TYPE_POZYX;
